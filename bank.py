...
def write(master,name,oc,pin):
	...
	# f1=open(r"C:\Users\Naren\source\repos\OneDrive\Desktop\GitHub\Bank-Management-System\txt\Accnt_Record.txt",'r')
	...
	accnt_no = (first_five + last_digit)
	

	fdet=open(fr"C:\Users\Naren\source\repos\OneDrive\Desktop\GitHub\Bank-Management-System\Data\Customer_Details\{name}_{accnt_no}_record.txt","w")
	fdet.write(name+"\n")
	...
	frec=open(fr"C:\Users\Naren\source\repos\OneDrive\Desktop\GitHub\Bank-Management-System\Data\Transaction_Details\{name}_{accnt_no}_record.txt",'w')
...
def logged_in_menu(accnt,name):
	...
	label.pack(side="top")
	img2=tk.PhotoImage(file=r"C:\Users\Naren\source\repos\OneDrive\Desktop\GitHub\Bank-Management-System\Images\credit.gif")
	myimg2=img2.subsample(2,2)
	img3=tk.PhotoImage(file=r"C:\Users\Naren\source\repos\OneDrive\Desktop\GitHub\Bank-Management-System\Images\debit.gif")
	myimg3=img3.subsample(2,2)
	img4=tk.PhotoImage(file=r"C:\Users\Naren\source\repos\OneDrive\Desktop\GitHub\Bank-Management-System\Images\balance1.gif")
	myimg4=img4.subsample(2,2)
	img5=tk.PhotoImage(file=r"C:\Users\Naren\source\repos\OneDrive\Desktop\GitHub\Bank-Management-System\Images\transaction-1.gif")
	...
	img6=tk.PhotoImage(file=r"C:\Users\Naren\source\repos\OneDrive\Desktop\GitHub\Bank-Management-System\Images\logout-1.gif")
...
def Create():
	...
	b.pack(side="top")
	crwn.bind("<Return>", on_return_key)
	# crwn.bind("<Return>",command=lambda x:write(crwn,e1.get().strip(),e2.get().strip(),e3.get().strip()))
	return
...
def Main_Menu():
	...
	l_title.pack(side="top")
	imgc1=tk.PhotoImage(file=r"C:\Users\Naren\source\repos\OneDrive\Desktop\GitHub\Bank-Management-System\Images\new-1.gif")
	imglo=tk.PhotoImage(file=r"C:\Users\Naren\source\repos\OneDrive\Desktop\GitHub\Bank-Management-System\Images\login.gif")
	...
	b2.image=imglog
	img6=tk.PhotoImage(file=r"C:\Users\Naren\source\repos\OneDrive\Desktop\GitHub\Bank-Management-System\Images\quit-1.gif")
	myimg6=img6.subsample(2,2)
